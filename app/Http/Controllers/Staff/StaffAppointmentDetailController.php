    ...
    public function generateModelPreview(Request $request)
    {
        ...
        if (isset($model_info->document) && !empty($model_info->document)) {
            ...
            $appointment_variables = array(
                ...
                'completion_date'=>$date_of_completion ?? null,
                'probation_completed_date' => $probation_completed_date??null,
                'probation_order_date' =>$probation_order_date??null,
                ...
                'previous_appointment_date' => $previous_appointment_date??null,
