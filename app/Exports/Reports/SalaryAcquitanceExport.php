...
class SalaryAcquitanceExport implements FromView
{
    ...
    {
        return view('pages.reports.exports.salary-register', ['earings_field' =>  $this->earings_field,'deductions_field' =>  $this->deductions_field,'salary_info' =>  $this->salary_info,'payroll' =>  $this->payroll]);
    }
}