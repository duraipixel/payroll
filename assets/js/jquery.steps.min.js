...
!(function (a, b) {
    ...
    async function B(a, b, c, d, from = '') {
        
        // console.log(from, 'from tag')
        // console.log( c.currentIndex , 'current Index')
        // console.log(checkGoFurther(c.currentIndex), 'ajax form response');
        var checkVariable = await checkGoFurther(c.currentIndex);
        console.log( checkVariable, 'checkVariable')
        if( checkVariable && from == '' ){
            console.log('has eorreo not bsdlfj');
            return;
        }
        // console.log('inide');
        // return;
    ...
    function E(b, c, d, e) {
        ...
        console.log( d.currentIndex, ' d.currentIndex');
        console.log('come insg inseide',e);
    ...
    var $ = (a.fn.steps.contentMode = { html: 0, iframe: 1, async: 2 }),
        ...
        cb = (a.fn.steps.defaults = {
            ...
            onInit: function () {},
            labels: { cancel: "Cancel", current: "current step:", pagination: "Pagination", finish: "Finish", next: "Save & Next ➢", previous: "Previous", loading: "Loading ..." },
        });
})(jQuery);
