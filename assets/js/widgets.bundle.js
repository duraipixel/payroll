...
var KTChartsWidget22 = function () {
    ...
    return {
        init: function () {           
            initChart('#kt_chart_widgets_22_tab_1', '#kt_chart_widgets_22_chart_1', [40, 100, 15], true);
...
var KTChartsWidget27 = function () {
    ...
    var initChart = function() {
        ...
        var options = {
            ...
            colors: ['#3E97FF', '#F1416C', '#43a43c', '#FFC700', '#7239EA'],                                                                      
            xaxis: {
                categories: ["Present", "Absent", 'ML', 'CL', 'SL'],
                labels: {
                    formatter: function (val) {
                        return val + ""
                    },
...
var KTChartsWidget5 = function () {
    ...
    var initChart = function() {
        ...
        var options = {
            ...
            colors: ['#3E97FF', '#F1416C', '#43a43c', '#FFC700', '#7239EA', '#50CDCD', '#3F4254'],                                                                      
            xaxis: {
