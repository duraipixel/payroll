...
use App\Http\Controllers\ReportController;
 ...
 Route::get('test/entry/{month}/{institute_id}/{acadamic_id}', [App\Http\Controllers\AttendanceManagement\AttendanceManualEntryController::class, 'leaveAvailableDays'])->name('test.entry');
...
Route::get('/testCronData/{cron_date?}/{type?}', [App\Http\Controllers\TestOneController::class, 'getCronData']);
...
Route::group(['middleware' => 'auth'],  function () {
    ...
    Route::post('appointment-order/delete', [App\Http\Controllers\Master\AppointmentOrderModelController::class, 'delete'])->name('appointment.orders.delete');
