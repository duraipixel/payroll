...
<body>
    <div>
        <h2 style="text-align:center">AMALORPAVAM HR. SEC. SCHOOL</h2>
        <h3 style="text-align:center"> APPLICATION FOR MATERNITY LEAVE </h3>
    </div>
    <table class="noborder" style="width: 100%">
        <tr>
            <td style="width:16%;text-align:left">APPLICATION NO : </td>
            <td style="width:34%;text-align:left"> <b> AHS00002320012</b></td>
            <td style="width:40%;text-align:right">DATE  OF APPLICATION : </td>
            <td style="width:10%;text-align:right"><b>12/05/2023</b></td>
        </tr>
    </table>
    <table class="leave-table" style="width: 100%;margin-top:5px;" cellspacing="0" padding="0">
        <tr style="border:1px solid">
            ...
            <td class="noborder-s" style="width:45%;text-align:left"> S.Durairaj </td>
        </tr>
        <tr>
            <td class="noborder-e" style="width:5%;text-align:center">02.</td>
            <td class="noborder-x" style="width:45%;text-align:left">Staff Id</td>
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left">AMV10235502012510</td>
        </tr>
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left">Vice President</td>
        </tr>
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left">1</td>
        </tr>
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left"> 25000</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left"> 02/05/2023 - 03/06/2023 </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left"> Second Street, Chennai </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left"> Yes </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left"> Execute with approvals </td>
        </tr>
        <tr>
            ...
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left"> Brito  </td>
        </tr>
        <tr>
            <td class="noborder-e" style="width:5%;text-align:center"> E.</td>
            <td class="noborder-x" style="width:45%;text-align:left"> Designation   </td>
            <td class="noborder-x" style="width:5%;text-align:center">:</td>
            <td class="noborder-s" style="width:45%;text-align:left"> Principal  </td>
        </tr>
        <tr>
