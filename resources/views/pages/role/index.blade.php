    ...
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                {!! searchSvg() !!}
                <input type="text" data-kt-user-table-filter="search" id="role_datable_search"
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <a type="button" class="btn btn-light-primary me-3 btn-sm" href="{{ route('role.export') }}">
                    {!! exportSvg() !!}
                    Export
                </a>

                <button type="button" class="btn btn-primary btn-sm" id="add_modal" onclick="getRoleModal()">
                    {!! plusSvg() !!} Add Role
                </button>
...
<script>
    var dtTable = $('#role_table').DataTable({
        ...
        ajax: {
            "url": "{{ route('role') }}",
            "data": function(d) {
                d.datatable_search = $('#role_datable_search').val();
            }
        },
        ...
        document.querySelector('#role_datable_search').addEventListener("keyup", function(e) {
            dtTable.draw();
        }),
