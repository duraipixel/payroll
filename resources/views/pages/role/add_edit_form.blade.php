<form action="" class="" id="dynamic_form">
   ...
   <input type="hidden" name="form_type" id="form_type" value="{{ $from ?? '' }}">
    ...
    <div class="fv-row form-group mb-10">
        ...
        <div >
            <input type="text" class="form-control" name="role_name" value="{{ $info->name ?? '' }}" id="role_name" required >
        </div>
    </div>
                                ...
                                if( res.error == 1 ) {
                                    ...
                                    if (from) {
                                        ...
                                        if( res.inserted_data ) {
                                            $('#role_id').append(`<option value="${res.inserted_data.id}">${res.inserted_data.name}</option>`)
                                            $('#role_id').val(res.inserted_data.id).trigger('change');
                                        }
                                    }
                                }
                            }
