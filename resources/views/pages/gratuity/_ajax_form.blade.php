...
<div class="row  mt-3">
    ...
    <div class="col-sm-6">
        <input type="text" readony name="last_post_held" id="last_post_held"
            value="{{ $staff_info->appointment?->designation?->name ?? '' }}" class="form-control form-control-sm"
            required>
    </div>
</div>
<div class="row  mt-3">
    ...
    <div class="col-sm-6">
        <input type="date" value="{{ $staff_info->appointment?->from_appointment ?? '' }}" readonly
...
<div class="row  mt-3">
    ...
    <div class="col-sm-6">
        <input type="date" value="{{ $staff_info->appointment?->to_appointment ?? '' }}" readonly
...
<div class="row mt-3">
    ...
    <div class="col-sm-6 d-flex align-items-center">
        <input type="text" name="gross_service_year" id="gross_service_year" onkeyup="qulifyingServiceAmountCalculation()" class="form-control form-control-sm w-100px me-1 price" required> years and
        <input type="text" name="gross_service_month" id="gross_service_month" onkeyup="qulifyingServiceAmountCalculation()" class="form-control form-control-sm w-100px ms-3 me-1 price" required> months
    </div>
</div>
<div class="row  mt-3">
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <input type="text" name="extraordinary_leave" onkeyup="qulifyingServiceAmountCalculation()"  id="extraordinary_leave" class="form-control price form-control-sm">
    </div>
</div>
<div class="row  mt-3">
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <input type="text" name="suspension_qualifying_service" onkeyup="qulifyingServiceAmountCalculation()"  id="suspension_qualifying_service"
...
<div class="row  mt-3">
    ...
    <div class="col-sm-6">
        <input type="text" name="net_qualifying_service" required id="net_qualifying_service"
            class="form-control form-control-sm price">
    </div>
</div>
<div class="row mt-3">
...
<div class="row  mt-3">
    ...
    <div class="col-sm-6">
        <input type="text" name="total_emuluments" requried id="total_emuluments"
            class="form-control form-control-sm price text-end" value="{{ $total_emul ?? 0 }}">
    </div>
</div>
<div class="row  mt-3">
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <input type="text" name="gratuity_calculation" required id="gratuity_calculation"
            class="form-control form-control-sm price text-end" value="">
    </div>
</div>
<div class="row  mt-3">
    <div class="col-sm-6">
