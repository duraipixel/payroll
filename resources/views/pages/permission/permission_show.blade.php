            ...
            <div class="container">
                ...
                <div class="col-12 pb-3">
                    <h4> <strong>Account Menu</strong>
                        <input type="checkbox" name="account_select_all" id="account_select_all"
                            @if ($account_select_all == 1) checked @endif onclick="account_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    ...
                    @foreach ($account as $key => $account_menu)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="account_checkox"
                                    name="account_select_all_row_wise_{{ $acc_i }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="account_select_all_row_wise_{{ $acc_i }}"
                                    onclick="account_row({{ $acc_i }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $account_menu }}</span>
                                <input type="hidden" name="account_menu_name[]" id="account_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">

                                <input type="checkbox" class="account_checkox" name="{{ $key_value }}_add"
                                    @if ($add_val == 1) checked @endif value="1"
                                    id="account_add_{{ $acc_i }}">
                            </div>
                            <div class="col-1">

                                <input type="checkbox" class="account_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="account_view_{{ $acc_i }}">
                            </div>
                            <div class="col-1">

                                <input type="checkbox" class="account_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="account_delete_{{ $acc_i }}">
                            </div>
                            <div class="col-1">

                                <input type="checkbox" class="account_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="account_export_{{ $acc_i }}">
                            </div>
                        </div>
                        @php
                            $acc_i++;
                ...
                <div class="col-12 pb-3">
                    <h4> <strong>Authentication Menu</strong>
                        <input type="checkbox" name="auth_select_all" id="auth_select_all"
                            @if ($auth_select_all == 1) checked @endif onclick="auth_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($authentication as $key => $authentication_menu)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="auth_checkox"
                                    name="auth_select_all_row_wise_{{ $auth_i }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="auth_select_all_row_wise_{{ $auth_i }}"
                                    onclick="auth_row({{ $auth_i }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $authentication_menu }}</span>
                                <input type="hidden" name="auth_menu_name[]" id="auth_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="auth_checkox"
                                    @if ($add_val == 1) checked @endif name="{{ $key_value }}_add"
                                    value="1" id="auth_add_{{ $auth_i }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="auth_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="auth_view_{{ $auth_i }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="auth_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="auth_delete_{{ $auth_i }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="auth_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="auth_export_{{ $auth_i }}">
                            </div>
                        </div>
                        @php
                            $auth_i++;
                ...
                <div class="col-12 pb-3">
                    <h4> <strong>Staff Management</strong>
                        <input type="checkbox" name="staff_select_all" id="staff_select_all"
                            @if ($sm_select_all == 1) checked @endif onclick="staff_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($staff_management as $key => $staff_managements)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="staff_checkox"
                                    name="staff_select_all_row_wise_{{ $si }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="staff_select_all_row_wise_{{ $si }}"
                                    onclick="staff_row({{ $si }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $staff_managements }}</span>
                                <input type="hidden" name="staff_menu_name[]" id="staff_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="staff_checkox" name="{{ $key_value }}_add"
                                    @if ($add_val == 1) checked @endif value="1"
                                    id="staff_add_{{ $si }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="staff_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="staff_view_{{ $si }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="staff_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="staff_delete_{{ $si }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="staff_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="staff_export_{{ $si }}">
                            </div>
                        </div>
                ...
                <div class="col-12 pb-3">
                    <h4> <strong>Document Locker</strong>
                        <input type="checkbox" name="dl_select_all" @if ($dl_select_all == 1) checked @endif
                            id="dl_select_all" onclick="dl_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($document_locker as $key => $document_lockers)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="dl_checkox"
                                    name="dl_select_all_row_wise_{{ $dli }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="dl_select_all_row_wise_{{ $dli }}"
                                    onclick="dl_row({{ $dli }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $document_lockers }}</span>
                                <input type="hidden" name="dl_menu_name[]" id="dl_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="dl_checkox" name="{{ $key_value }}_add"
                                    @if ($add_val == 1) checked @endif value="1"
                                    id="dl_add_{{ $dli }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="dl_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="dl_view_{{ $dli }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="dl_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="dl_delete_{{ $dli }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="dl_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="dl_export_{{ $dli }}">
                            </div>
                        </div>
                ...
                {{-- Do Dynamic Routes here --}}
                {{-- @if (config('permission') && !empty(config('permission')))
                    @foreach (config('permission') as $dyn_key => $dyn_value)
                        <div class="col-12 pb-3">
                            <h4> <strong>{{ ucfirst(str_replace(['-', '_'], ' ', $dyn_key)) }}</strong>
                                <input type="checkbox" name="bm_select_all" id="bm_select_all"
                                    onclick="bm_select_all_func();">
                            </h4>
                        </div>
                    @endforeach
                @endif --}}
                ...
                <div class="col-12 pb-3">
                    <h4> <strong>Block Mapping</strong>
                        <input type="checkbox" name="bm_select_all" id="bm_select_all"
                            @if ($bm_select_all == 1) checked @endif onclick="bm_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($block_mapping as $key => $block_mappings)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="bm_checkox"
                                    name="bm_select_all_row_wise_{{ $bmi }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="bm_select_all_row_wise_{{ $bmi }}"
                                    onclick="bm_row({{ $bmi }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $block_mappings }}</span>
                                <input type="hidden" name="bm_menu_name[]" id="bm_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="bm_checkox" name="{{ $key_value }}_add"
                                    @if ($add_val == 1) checked @endif value="1"
                                    id="bm_add_{{ $bmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="bm_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="bm_view_{{ $bmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="bm_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="bm_delete_{{ $bmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="bm_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="bm_export_{{ $bmi }}">
                            </div>
                        </div>
                ...
                <div class="col-12 pb-3">
                    <h4> <strong> Attendance Management</strong>
                        <input type="checkbox" name="att_man_select_all"
                            @if ($am_select_all == 1) checked @endif id="att_man_select_all"
                            onclick="att_man_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($attendance_management as $key => $attendance_managements)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="att_man_checkox"
                                    name="att_man_select_all_row_wise_{{ $att_mani }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="att_man_select_all_row_wise_{{ $att_mani }}"
                                    onclick="att_man_row({{ $att_mani }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $attendance_managements }}</span>
                                <input type="hidden" name="att_man_menu_name[]" id="att_man_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="att_man_checkox" name="{{ $key_value }}_add"
                                    @if ($add_val == 1) checked @endif value="1"
                                    id="att_man_add_{{ $att_mani }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="att_man_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="att_man_view_{{ $att_mani }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="att_man_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="att_man_delete_{{ $att_mani }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="att_man_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="att_man_export_{{ $att_mani }}">
                            </div>
                        </div>
                        @php
                            $att_mani++;
                        ...
                        @endphp
                    @endforeach
                    <input type="hidden" name="att_man_row_count" id="att_man_row_count"
                        value="{{ $att_man_row }}">
                </div> <br>
                ...
                <div class="col-12 pb-3">
                    <h4> <strong> Leave Management</strong>
                        <input type="checkbox" name="lm_select_all" @if ($lm_select_all == 1) checked @endif
                            id="lm_select_all" onclick="lm_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($leave_management as $key => $leave_managements)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="lm_checkox"
                                    name="lm_select_all_row_wise_{{ $lmi }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="lm_select_all_row_wise_{{ $lmi }}"
                                    onclick="lm_row({{ $lmi }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $leave_managements }}</span>
                                <input type="hidden" name="lm_menu_name[]" id="lm_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="lm_checkox" name="{{ $key_value }}_add"
                                    @if ($add_val == 1) checked @endif value="1"
                                    id="lm_add_{{ $lmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="lm_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="lm_view_{{ $lmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="lm_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="lm_delete_{{ $lmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="lm_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="lm_export_{{ $lmi }}">
                            </div>
                        </div>
                ...
                <div class="col-12 pb-3">
                    <h4> <strong> Payroll Management</strong>
                        <input type="checkbox" name="prm_select_all" id="prm_select_all"
                            @if ($pm_select_all == 1) checked @endif onclick="prm_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($payroll_management as $key => $payroll_managements)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="prm_checkox"
                                    name="prm_select_all_row_wise_{{ $prmi }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="prm_select_all_row_wise_{{ $prmi }}"
                                    onclick="prm_row({{ $prmi }});">
                            </div>
                            <div class="col-5">
                                <span class="pl-3"> {{ $payroll_managements }}</span>
                                <input type="hidden" name="prm_menu_name[]" id="prm_menu_name"
                                    value="{{ $key }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="prm_checkox" name="{{ $key_value }}_add"
                                    @if ($add_val == 1) checked @endif value="1"
                                    id="prm_add_{{ $prmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="prm_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="prm_view_{{ $prmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="prm_checkox" name="{{ $key_value }}_delete"
                                    @if ($delete_val == 1) checked @endif value="1"
                                    id="prm_delete_{{ $prmi }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="prm_checkox" name="{{ $key_value }}_export"
                                    @if ($export_val == 1) checked @endif value="1"
                                    id="prm_export_{{ $prmi }}">
                            </div>
                        </div>
                ...
                <div class="col-12 pb-3">
                    <h4> <strong>Master Menu</strong>
                        <input type="checkbox" name="master_select_all"
                            @if ($master_select_all == 1) checked @endif id="master_select_all"
                            onclick="master_select_all_func();">
                    </h4>
                </div>
                <div class="row justify-content-start">
                    <div class="row mb-6">
                    ...
                    @foreach ($master_menu as $key => $master_menus)
                        <div class="row mb-6">
                            ...
                            @endphp
                            <div class="col-1">
                                <input type="checkbox" class="master_checkox"
                                    name="select_all_row_wise_{{ $i }}"
                                    @if ($add_val == 1 && $view_val == 1 && $delete_val == 1 && $export_val == 1) checked @endif
                                    id="select_all_row_wise_{{ $i }}"
                                    onclick="master_row({{ $i }});">
                            </div>
                            <div class="col-5">
                            ...
                            <div class="col-1">
                                <input type="checkbox" class="master_checkox"
                                    @if ($add_val == 1) checked @endif name="{{ $key_value }}_add"
                                    value="1" id="master_add_{{ $i }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="master_checkox" name="{{ $key_value }}_view"
                                    @if ($view_val == 1) checked @endif value="1"
                                    id="master_view_{{ $i }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="master_checkox" name="{{ $key_value }}_delete"
                                    value="1" @if ($delete_val == 1) checked @endif
                                    id="master_delete_{{ $i }}">
                            </div>
                            <div class="col-1">
                                <input type="checkbox" class="master_checkox" name="{{ $key_value }}_export"
                                    value="1" @if ($export_val == 1) checked @endif
                                    id="master_export_{{ $i }}">
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('.account_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("account_add_" + acc_k).checked == false) || (document
                        .getElementById("account_view_" + acc_k).checked == false) || (document
                        .getElementById("account_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("account_add_" + acc_k).checked == true) && (
                        document.getElementById("account_view_" + acc_k).checked == true) && (document
                        .getElementById("account_delete_" + acc_k).checked == true) &&
        ...
        $('.auth_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("auth_add_" + acc_k).checked == false) || (document
                        .getElementById("auth_view_" + acc_k).checked == false) || (document
                        .getElementById("auth_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("auth_add_" + acc_k).checked == true) && (document
                        .getElementById("auth_view_" + acc_k).checked == true) && (document
                        .getElementById("auth_delete_" + acc_k).checked == true) &&
        ...
        $('.staff_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("staff_add_" + acc_k).checked == false) || (document
                        .getElementById("staff_view_" + acc_k).checked == false) || (document
                        .getElementById("staff_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("staff_add_" + acc_k).checked == true) && (document
                        .getElementById("staff_view_" + acc_k).checked == true) && (document
                        .getElementById("staff_delete_" + acc_k).checked == true) &&
        ...
        $('.dl_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("dl_add_" + acc_k).checked == false) || (document
                        .getElementById("dl_view_" + acc_k).checked == false) || (document
                        .getElementById("dl_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("dl_add_" + acc_k).checked == true) && (document
                        .getElementById("dl_view_" + acc_k).checked == true) && (document
                        .getElementById("dl_delete_" + acc_k).checked == true) &&
        ...
        $('.bm_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("bm_add_" + acc_k).checked == false) || (document
                        .getElementById("bm_view_" + acc_k).checked == false) || (document
                        .getElementById("bm_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("bm_add_" + acc_k).checked == true) && (document
                        .getElementById("bm_view_" + acc_k).checked == true) && (document
                        .getElementById("bm_delete_" + acc_k).checked == true) &&
        ...
        $('.att_man_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("att_man_add_" + acc_k).checked == false) || (document
                        .getElementById("att_man_view_" + acc_k).checked == false) || (document
                        .getElementById("att_man_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("att_man_add_" + acc_k).checked == true) && (
                        document.getElementById("att_man_view_" + acc_k).checked == true) && (document
                        .getElementById("att_man_delete_" + acc_k).checked == true) &&
        ...
        $('.lm_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("lm_add_" + acc_k).checked == false) || (document
                        .getElementById("lm_view_" + acc_k).checked == false) || (document
                        .getElementById("lm_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("lm_add_" + acc_k).checked == true) && (document
                        .getElementById("lm_view_" + acc_k).checked == true) && (document
                        .getElementById("lm_delete_" + acc_k).checked == true) &&
        ...
        $('.prm_checkox').click(function() {
            ...
            for (let acc_k = 1; acc_k <= acc_row_count; acc_k++) {
                if ((document.getElementById("prm_add_" + acc_k).checked == false) || (document
                        .getElementById("prm_view_" + acc_k).checked == false) || (document
                        .getElementById("prm_delete_" + acc_k).checked == false) ||
                ...
                } else if ((document.getElementById("prm_add_" + acc_k).checked == true) && (document
                        .getElementById("prm_view_" + acc_k).checked == true) && (document
                        .getElementById("prm_delete_" + acc_k).checked == true) &&
        ...
        $('.master_checkox').click(function() {
            ...
            for (let k = 1; k <= row_count; k++) {
                if ((document.getElementById("master_add_" + k).checked == false) || (document
                        .getElementById("master_view_" + k).checked == false) || (document
                        .getElementById("master_delete_" + k).checked == false) ||
                ...
                } else if ((document.getElementById("master_add_" + k).checked == true) && (document
                        .getElementById("master_view_" + k).checked == true) && (document
                        .getElementById("master_delete_" + k).checked == true) &&
