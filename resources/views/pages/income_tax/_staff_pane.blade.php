...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active tax-link income" data-id="income" onclick="return getTaxTabInfo('income')" aria-current="page" href="javascript:void(0)">
            Income
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link tax-link deductions" data-id="deductions" onclick="return getTaxTabInfo('deductions')" href="javascript:void(0)">Deductions</a>
    </li>
    <li class="nav-item">
