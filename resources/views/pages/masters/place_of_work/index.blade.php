    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <a type="button" class="btn btn-light-primary me-3 btn-sm" href="{{ route('workplace.export') }}">
                    {!! exportSvg() !!}
                    Export
                </a>

                <button type="button" class="btn btn-primary btn-sm" id="add_modal" onclick="getPlaceOfWorkModal()">
