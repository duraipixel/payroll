<form action="" class="" id="dynamic_form">
    ...
    <div class="fv-row form-group mb-10">
        ...
        <div>
            <input type="text" class="form-control" name="type_name" id="type_name" value="{{  $info->name ?? '' }}"  required >
        </div>
    </div>
                            ...
                            success: function(res) {
                                ...
                                if( res.error == 1 ) {
                                    ...
                                    if( res.inserted_data ) {
                                        $('#course_professional_type').append(`<option value="${res.inserted_data.id}">${res.inserted_data.name}</option>`)
                                        $('#course_professional_type').val(res.inserted_data.id).trigger('change');
                                    }
                                }
                                }
                            }
