<form action="" class="" id="dynamic_form">
    ...
    <div class="fv-row form-group mb-10">
        ...
        <div >
            <input type="text" class="form-control" name="board_name" id="board_name" value="{{  $info->name ?? '' }}" required >
        </div>
    </div>
...
<script>
    var from = '{{ $from ?? '' }}';
var KTAppEcommerceSaveBoard = function () {
