    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-user-table-filter="search" id="board_dataTable_search"
                    class="form-control form-control-solid w-250px ps-14" placeholder="Search Board">
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <a type="button" class="btn btn-light-primary me-3" href="{{ route('board.export') }}">
                ...
                <button type="button" class="btn btn-primary" id="add_modal" onclick="getBoardModal()">
                    {!! plusSvg() !!} Add Board
                </button>
...
<script>
    var dtTable = $('#board_table').DataTable({
        ...
        ajax: {
            "url": "{{ route('board') }}",
            "data": function(d) {
                d.datatable_search = $('#board_dataTable_search').val();
            }
        },
        ...
        document.querySelector('#board_dataTable_search').addEventListener("keyup", function(e) {
            dtTable.draw();
        }),
