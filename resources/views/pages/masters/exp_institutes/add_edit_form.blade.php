...
var KTAppEcommerceSaveExperincedInstitute = function () {
                            ...
                            success: function(res) {
                                ...
                                if( res.error == 1 ) {
                                    ...
                                    if( res.inserted_data ) {
                                        ...
                                        $('#experience_institute_name').append(`<option value="${res.inserted_data.id}">${res.inserted_data.name}</option>`)
                                        $('#experience_institute_name').val(res.inserted_data.id);
                                    }
                                }
                            }
                        })
...
KTUtil.onDOMContentLoaded(function () {
    KTAppEcommerceSaveExperincedInstitute.init();
});
