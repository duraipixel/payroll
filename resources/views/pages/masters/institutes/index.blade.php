        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <a type="button" class="btn btn-light-primary me-3" href="{{ route('institutions.export') }}">
                    ...
                    <button type="button" class="btn btn-primary" id="add_modal" onclick="getInstituteModal()">
