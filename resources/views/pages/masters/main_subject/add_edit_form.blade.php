                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                if( res.error == 1 ) {
                                    ...
                                    toastr.success("Ancillary Subject added successfully");
                                    if( res.inserted_data ) {
                                        $('#kt_dynamic_app').modal('hide');
                                        $('#main_subject_id').append(`<option value="${res.inserted_data.id}">${res.inserted_data.name}</option>`)
                                        $('#main_subject_id').val(res.inserted_data.id).trigger('change');
                                    }
                                }
                            }
                        })
