                            ...
                            success: function(res) {
                                ...
                                if( res.error == 1 ) {
                                    ...
                                    if( res.inserted_data ) {
                                        ...
                                        $('#working_relationship_type_id').append(`<option value="${res.inserted_data.id}">${res.inserted_data.name}</option>`)
                                        $('#working_relationship_type_id').val(res.inserted_data.id).trigger('change');
                                    }
                                }
                            }
                        })
