                            ...
                            success: function(res) {
                                ...
                                if( res.error == 1 ) {
                                    ...
                                    if( res.inserted_data ) {
                                        ...
                                        $('#ancillary_subject_id').append(`<option value="${res.inserted_data.id}">${res.inserted_data.name}</option>`)
                                        $('#ancillary_subject_id').val(res.inserted_data.id).trigger('change');
