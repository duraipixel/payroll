<form action="" class="" id="dynamic_form">
    ...
    <div class="fv-row form-group mb-10">
        ...
        <div>
            <input type="text" class="form-control" name="qualification" value="{{ $info->name ?? '' }}" id="qualification" required >
        </div>
    </div>
                            ...
                            success: function(res) {
                                ...
                                if( res.error == 1 ) {
                                    ...
                                    if( res.inserted_data ) {
                                        $('#qualification_id').append(`<option value="${res.inserted_data.id}">${res.inserted_data.name}</option>`)
                                        $('#qualification_id').val(res.inserted_data.id).trigger('change');
                                    }
                                }
                                }
                            }
