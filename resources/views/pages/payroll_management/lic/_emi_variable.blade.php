            ...
            @foreach ($info->emi as $item)
                <tr class="">
                    ...
                    <td class="text-end px-2">
                        <input type="text" name="emi_amount[]" class="form-input text-end price"
                            value="{{ $item->amount ?? 0 }}" required>
                    </td>
                </tr>
            @endforeach
        </table>
        ...
        @if (isset($emi_details) && !empty($emi_details))
            @foreach ($emi_details as $item)
                <tr class="">
                    ...
                    <td class="text-end px-2">
                        <input type="text" name="emi_amount[]" class="form-input text-end price" value=""
                            required>
                    </td>
                </tr>
            @endforeach
