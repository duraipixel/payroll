    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-user-table-filter="search" id="salary_head_dataTable_search"
                    class="form-control form-control-solid w-250px ps-14" placeholder="Search Salary Head">
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <button type="button" class="btn btn-primary" id="add_modal" onclick="getSalaryHeadModal()">
...
<script>
    var dtTable = $('#salary_head_table').DataTable({
        ...
        function getSalaryHeadModal( id = '') {
        ...
        function salaryHeadChangeStatus(id, status) {
