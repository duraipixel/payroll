...
@section('content')
        ...
        <div class="month_row d-flex">
            ...
            @for ($i = 0; $i < 12; $i++)
                ...
                <div id="payroll_month_{{ $months }}" role="button"
                    ...
                    onclick="getHoldView('{{ $dates }}', {{ $months }})">
    ...
    <div class="card mt-3" id="hold_overview_container">

        @include('pages.payroll_management.hold.view_ajax')
    </div>
@endsection
...
@section('add_on_script')
    <script>
        ...
        function getHoldView(hdate, hmonth) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    $('#hold_overview_container').html(res);
                },
                error: function(xhr, err) {
                    if (xhr.status == 403) {
                        toastr.error(xhr.statusText, 'UnAuthorized Access');
