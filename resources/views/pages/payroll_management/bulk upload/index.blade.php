 ...
 @section('content')
     ...
     <div class="card">
        ...
        <form method="POST" action="{{ route('payroll.bulk.head.upload.save') }}" enctype="multipart/form-data">
             ...
             @endif
             <!--end::Card body-->
                          <h5>Loan Bulk Upload </h5>
        <form method="POST" action="{{ route('payroll.bulk.loan.upload.save') }}" enctype="multipart/form-data">
                 @csrf
                 <div class="row">
                     <!--begin::Input group-->
                     <div class="col-lg-6 mb-5">
                     ...
                     <div class="col-lg-6 mb-5">
                        ...
                        <a  class="btn btn-primary" href="{{ route('bulk.loan.sample.download') }}">Download</a> <br><label class="form-label">Download Sample Excel</label>
