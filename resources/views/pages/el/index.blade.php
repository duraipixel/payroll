            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    @if (access()->buttonAccess($route_name, 'add_edit'))
                        <a href="{{ route('gratuity-el.add_edit', ['type' => $page_type]) }}" class="btn btn-primary btn-sm">
                            {!! plusSvg() !!} Add {{ $title }} Earned Leave </a>
                    @endif
                </div>
                    ...
                    <table class="table align-middle text-center table-hover table-bordered table-striped fs-7 no-footer"
                        ...
                        <thead class="bg-primary">
                            <tr class="text-start text-center text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-white">
                                    Total Earned Leave Day
                                </th>
                                <th class="text-white">
                                    Total Earned Leave Encashment 
                                </th>
                                <th class="text-center text-white">
                                    Verification Status
                                </th>
...
@section('add_on_script')
    <script>
        var dtTable_o = $('#board_table').DataTable({
            ...
            type: 'POST',
            ajax: {
                "url": "{{ route('gratuity-el', ['type' => $page_type]) }}",
                "data": function(d) {
