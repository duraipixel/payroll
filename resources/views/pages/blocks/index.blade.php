    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <a type="button" class="btn btn-light-primary me-3" href="{{ route('blocks.export') }}">
                ...
                <button type="button" class="btn btn-primary" id="add_modal" onclick="getBlocksModal()">
                    {!! plusSvg() !!} Add Blocks
                </button>
...
<script>
    ...
    var dtTable = $('#blocks_table').DataTable({
        ...
        ajax: {
            "url": "{{ route('blocks') }}",
            "data": function(d) {
                d.datatable_search = $('#blocks_dataTable_search').val();
            }
        },
        columns: [
            {
            ...
            {
                data: 'place_of_works_name',
                name: 'place_of_works_name'
            },
            {
                data: 'status',
                name: 'status'
        ...
        document.querySelector('#blocks_dataTable_search').addEventListener("keyup", function(e) {
            dtTable.draw();
        }),
        ...
        function blocksChangeStatus(id, status) {
    ...
    if (result.value) {
        ...
        $.ajax({
            url: "{{ route('blocks.change.status') }}",
            type: 'POST',
            data: {
                id: id,
                status: status
