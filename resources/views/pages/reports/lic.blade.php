        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    {!! searchSvg() !!}
                    <input type="text" data-kt-user-table-filter="search" id="lic_datatable_search"
    ...
    <script>
        var dtTable = $('#lic_table').DataTable({
            ...
            ajax: {
                ...
                "data": function(d) {
                    d.datatable_search = $('#lic_datatable_search').val();
                      d.month = $('#month').val();
                }
            },
        ...
        document.querySelector('#lic_datatable_search').addEventListener("keyup", function(e) {
            dtTable.draw();
        });
