        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    {!! searchSvg() !!}
                    <input type="text" data-kt-user-table-filter="search" id="user_datatable_search"
...
@section('add_on_script')
    <script>
        var dtTable = $('#bank_loan_table').DataTable({
            ...
            type: 'POST',
            ajax: {
                "url": "{{ route('reports.resignation.report') }}",
                "data": function(d) {
                    d.datatable_search = $('#user_datatable_search').val();
                  d.month = $('#month').val();
                }
            },
        ...
        document.querySelector('#user_datatable_search').addEventListener("keyup", function(e) {
            dtTable.draw();
        });
