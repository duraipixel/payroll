...
@section('content')
    <div class="card">
         <form action="{{ route('reports.resignation.report') }}" class="input-group w-auto d-inline"
                        method="GET">
        <div class="card-header border-0 pt-6">
          ...
          @if (access()->buttonAccess($route_name, 'export'))
                 <button onclick="this.form.action = '{{ route('reports.resignation.export') }}'" type="submit"
