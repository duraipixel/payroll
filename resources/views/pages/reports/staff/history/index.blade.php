    ...
    <section style="min-height: 93vh" class="p-3">
        <div class="card shadow border border-secondary rounded">
            <div class="bg-light border-bottom p-2 d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex">
                    <form action="{{ route('staff.index') }}" class="input-group w-auto d-inline" method="GET">
                        ...
                        <button onclick="this.form.action = '{{ route('staff.index') }}';" type="submit" class="btn btn-sm btn-primary"><i class="fa fa-search"></i> Find</button>
                        <a href="{{ route('staff.index') }}" class="btn btn-sm btn-warning">
