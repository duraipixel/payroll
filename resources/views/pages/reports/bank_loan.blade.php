...
@section('content')
    <div class="card">
         <form action="{{ route('reports.bank.loan.report') }}" class="input-group w-auto d-inline"
                        method="GET">
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                  ...
                  <button onclick="this.form.action = '{{ route('reports.bankloan.export') }}'" type="submit"
...
@section('add_on_script')
    <script>
        var dtTable = $('#bank_loan_table').DataTable({
            ...
            type: 'POST',
            ajax: {
                "url": "{{ route('reports.bank.loan.report') }}",
                "data": function(d) {
