...
@section('content')
    <div class="card">
         <form action="{{ route('reports.income.tax.report') }}" class="input-group w-auto d-inline"
                        method="GET">
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <button onclick="this.form.action = '{{ route('reports.incometax.export') }}'" type="submit"
...
@section('add_on_script')
    <script>
        var dtTable = $('#data_table').DataTable({
            ...
            type: 'POST',
            ajax: {
                "url": "{{ route('reports.income.tax.report') }}",
                "data": function(d) {
             ...
             columns: [
                ...
                {
                    data: 'deduction_80c_amount',
                    name: 'So far deducted'
                },{
                    data: 'total_deduction_amount',
                    name: 'Amount deducted (current month)'
                },{
                    data: 'gross_income',
                    name: 'Balance to be deducted'
                },   
            ],
            language: {
                paginate: {
