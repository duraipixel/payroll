<table border="1">
    <thead>
           <tr>
    <th colspan="7" style="text-align: center;"> {{getInstituteName($institute_id)}}, PUDUCHERRY</th>
    </tr>
    <tr>
     <th colspan="7" style="text-align: center; text-transform: capitalize">BONUS REPORT FOR THE MONTH OF {{getMonthName($from_date)}}</th>
    </tr>
        <tr>
