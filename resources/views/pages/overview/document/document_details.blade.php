            ...
            <div class="tab-content w-100" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-personal" role="tabpanel"
                    ...
                    <table
                        ...
                        @if (isset($personal_doc) && !empty($personal_doc))
                ...
                <div class="tab-pane fade" id="v-pills-education" role="tabpanel"
                    ...
                    <table
                        ...
                        @if (isset($education_doc) && !empty($education_doc))
                            @foreach ($education_doc as $education_docs)
                                <tr>
                        ...
                        @else
                            <tr>
                                <td colspan="6">
                                    <strong> Education Documents not Uploaded </strong>
                                </td>
                            </tr>
                        @endif
                    </table>
                ...
                <div class="tab-pane fade" id="v-pills-experience" role="tabpanel"
                    ...
                    <table
                        ...
                        @if (isset($experince_doc) && !empty($experince_doc))
                            @foreach ($experince_doc as $experince_docs)
                                <tr>
                ...
                <div class="tab-pane fade" id="v-pills-leave" role="tabpanel" aria-labelledby="v-pills-leave-tab">
                    <table
                        ...
                        @if (isset($leave_doc) && !empty($leave_doc))
                            @foreach ($leave_doc as $leave_docs)
                                <tr>
                ...
                <div class="tab-pane fade" id="v-pills-salary" role="tabpanel" aria-labelledby="v-pills-salary-tab">
                    ...
                    <table
                        ...
                        @if (isset($salary_doc) && !empty($salary_doc))
                            @foreach ($salary_doc as $salary_docs)
                                <tr>
                ...
                <div class="tab-pane fade" id="v-pills-appointment" role="tabpanel"
                    ...
                    <table
                        ...
                        @if (isset($salary_doc) && !empty($salary_doc))
                            @foreach ($appointment_doc as $appointment_docs)
                                <tr>
