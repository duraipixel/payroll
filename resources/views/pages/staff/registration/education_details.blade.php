               ...
               <div class="table-responsive">
                   ...
                   <table
                       ...
                       <tbody>
                           ...
                           <tr>
                               <td class="text-dark fw-bolder text-hover-primary fs-6">Malayalam
                               </td>
           ...
           <div class="card-header border-0 pt-0">
               ...
               <div id="kt_help" class="bg-body" data-kt-drawer="true"
                   ...
                   <div class="card shadow-none rounded-0 w-100">
                       <!--begin::Header-->
                       <div class="card-header" id="kt_help_header">
                           <h5 class="card-title fw-bold text-gray-600">Add your Past Experience
                           </h5>
                           <div class="card-toolbar">
                               <button type="button"
                                   class="btn btn-sm btn-icon explore-btn-dismiss me-n5"
           ...
           <div class="card-body py-3">
               ...
               <div class="table-responsive">
                   ...
                   <table
                       ...
                       <tbody>
                           <tr>
                               <td class="text-dark fw-bolder text-hover-primary fs-6">Donbosco
                               </td>
