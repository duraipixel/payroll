...
<div class="fv-row row">
    <input type="hidden" name="training_id" id="training_id" value="{{ $training_info->id ?? '' }}">
            ...
            <select name="training_topic" autofocus id="training_topic"
                ...
                @isset($training_topics)
                    @foreach ($training_topics as $item)
                        <option value="{{ $item->id }}" @if (isset($training_info->training_topic_id) && $training_info->training_topic_id == $item->id) selected @endif>
                            {{ $item->name }}
                        </option>
                    @endforeach
                @endisset
