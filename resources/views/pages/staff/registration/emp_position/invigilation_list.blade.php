<div class="table-responsive">
    ...
    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
        ...
        <!--begin::Table body-->
        <tbody>
            @isset($invigilation_details)
                @foreach ($invigilation_details as $item)
                <tr>
                    <td>
                        <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ $loop->index + 1 }}</a>
                    </td>
                    <td class="text-dark fw-bolder text-hover-primary fs-6">{{ $item->classes->name ?? '' }}
                    </td>
                    ...
                    <td class="text-end">
                        <a href="javascript:void(0)" onclick="return editDuty('{{ $item->id }}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                        ...
                        <a href="javascript:void(0)" onclick="return deleteDuty('{{ $item->id }}', '{{ $item->staff_id }}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
