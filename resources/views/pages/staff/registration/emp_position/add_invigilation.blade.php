<div class="card shadow-none rounded-0 w-100">
    ...
    <div class="card-header" id="kt_help_header">
        <h5 class="card-title fw-bold text-gray-600">Add your Duty Details
        </h5>
        ...
        <form id="invigilation">
            ...
            <div class="fv-row row">
                ...
                <div class="col-lg-6 mb-5">
                    ...
                    <div class="position-relative">
                        <select name="other_school" autofocus id="other_school"
                            class="form-select form-select-lg select2-option">
                ...
                <div class="col-lg-6 mb-5">
                    ...
                    <div class="position-relative">
                        <select name="other_place_id" autofocus id="other_place_id"
                            class="form-select form-select-lg select2-option">
                ...
                <div class="col-lg-6 mb-5">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <input class="form-control form-control-solid ps-12" placeholder="Select a date"
                            name="inv_from_date" id="inv_from_date" />
                        <!--end::Datepicker-->
                    </div>
                    <!--end::Input-->
                </div>
                ...
                <div class="col-lg-6 mb-5">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--begin::Datepicker-->
                        <input class="form-control form-control-solid ps-12" placeholder="Select a date"
                            name="inv_to_date" id="inv_to_date" />
                        <!--end::Datepicker-->
                    </div>
                    <!--end::Input-->
                </div>
                ...
                <div class="col-lg-6 mb-5">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input name="facility" id="facility" class="form-control form-control-lg form-control-solid" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <div class="d-flex flex-stack pt-5">
                    <!--begin::Wrapper-->
                    <div>
                        <button type="button" id="formsubmitbtn" class="btn btn-lg btn-primary me-3 d-inline-block">
...
<script>
    ...
    var KTAppEcommerceSaveInvigilation = function() {

        const handleSubmit = () => {
            // Define variables
            let validator;
            // Get elements
            const form = document.getElementById('invigilation');
    ...
    KTAppEcommerceSaveInvigilation.init();
