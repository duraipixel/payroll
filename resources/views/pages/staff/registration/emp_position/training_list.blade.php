        ...
        <tbody>
            @isset($training_details)
                ...
                <tr>
                    ...
                    <td class="text-dark fw-bolder text-hover-primary fs-6">{{ $item->remarks ?? '' }}
                    </td>
                    <td class="text-end">
                        <a href="#" onclick="return editTraining('{{ $item->id }}')"
                        ...
                        <a href="#" onclick="return deleteTraining('{{ $item->id }}', '{{ $item->staff_id }}')" 
