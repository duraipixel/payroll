...
<div class="row">
    ...
    <div class="col-lg-6 mb-5 nominee-pane @if( isset($nominee_info->minor_name) && !empty($nominee_info->minor_name)) @else d-none @endif"  >
        <label class="form-label">Guardian Name If Nominee is Minor
        </label>
    ...
    <div class="col-lg-6 mb-5 nominee-pane @if( isset($nominee_info->minor_name) && !empty($nominee_info->minor_name)) @else d-none @endif" >
        <label class="form-label">
            Contact Number If Nominee is Minor
        </label>
    ...
    <div class="col-lg-12 mb-5 nominee-pane @if( isset($nominee_info->minor_name) && !empty($nominee_info->minor_name)) @else d-none @endif" >
        
        <label class="form-label"> Address If Nominee is Minor </label>
    ...
    <div class="d-flex flex-stack pt-5">
        ...
        <div>
            <button type="button" onclick="return addNominee()"  class="btn btn-primary">
    ...
    function getNomineeDetails(nominee_id) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                console.log( age );
                if( age < 18 ) {
                    $('.nominee-pane').removeClass('d-none');
                } else {
                    $('.nominee-pane').addClass('d-none');
                }
                $('#nominee_age').val(age);
            }
        })
