                ...
                @foreach ($nominee_details as $item)
                    <tr>
                        ...
                        <td class="text-dark fw-bolder text-hover-primary fs-6">
                            {{ $item->share }}%</td>
                        <td class="text-end">
                            <a href="javascript:void(0)" onclick="editNomineeForm('{{ $item->staff_id }}', '{{ $item->id }}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <a href="#" onclick="deleteNominee('{{ $item->staff_id }}', '{{ $item->id }}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
