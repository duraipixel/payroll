...
<div class="row">
    ...
    <div class="col-lg-6 mb-5">
        ...
        <div class="d-flex">
            ...
            <select name="staff_relationship_id" autofocus id="staff_relationship_id" class="form-input" required>
    ...
    <div class="col-lg-6 mb-5">
        ...
        <input name="family_member_name" id="family_member_name" value="{{ $family_details->first_name ?? '' }}"
    ...
    <div class="col-lg-6 mb-5">
        ...
        <div class="d-flex d-flex align-items-center">
            {{-- {!! dobSVG() !!} --}}
            <input class="form-control form-control-solid ps-12" placeholder="Select a date" type="date"
                name="dob" id="dob" onchange="getAge(this.value)" value="{{ $family_details->dob ?? '' }}" />
        </div>
    </div>
    ...
    <div class="col-lg-6 mb-5">
        ...
        <input name="age" id="age" value="{{ $family_details->age ?? '' }}"
            class="number_only form-control form-control-lg form-control-solid" />
    ...
    <div class="col-lg-6 mb-5">
        ...
        <div class="d-flex">
            ...
            <select name="qualification_id" autofocus id="qualification_id" class="form-input" required>
    ...
    <div class="mb-5 col-lg-6 fv-row">
        ...
        <div class="d-inline-block flex-stack">
            ...
            <div class="d-block mt-5 align-items-center cstm-zeed">
                ...
                <label class="form-check form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-20px w-20px" type="radio" name="profession_type" value="studying"
    ...
    <div class="mb-5 col-lg-6 fv-row">
        <div class="d-inline-block flex-stack">
            ...
            <div class="d-block mt-5 align-items-center cstm-zeed">
                <label class="form-check form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-20px w-20px" type="radio" name="premises" value="amalarpavam"
                        @if (isset($family_details->premises) && $family_details->premises == 'amalarpavam') checked @endif />
                    <span class="form-check-label fw-bold">Amalarpavam</span>
                </label>
                <label class="form-check form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-20px w-20px" type="radio" name="premises" value="others"
                        @if (isset($family_details->premises) && $family_details->premises == 'others') checked @endif />
    ...
    <div class="col-lg-6 mb-5">
        ...
        <input name="family_contact_no" id="family_contact_no" maxlength="10"
            value="{{ $family_details->contact_no ?? '' }}"
            class="number_only form-control form-control-lg form-control-solid" />
    </div>
    ...
    <div class="col-lg-6 mb-5">
        ...
        <div class="d-flex">
            <select name="blood_group_id" autofocus id="blood_group_id" class="form-input" required>
    ...
    <div class="col-lg-6 mb-5">
        ...
        <div class="d-flex">
            <select name="family_nationality" autofocus id="family_nationality" class="form-input" required>
    ...
    <div class="col-lg-6 mb-5">
        ...
        <input name="family_remarks" id="family_remarks" value="{{ $family_details->remarks ?? '' }}"
            class="form-control form-control-lg form-control-solid" />
        <!--end::Input-->
    </div>
    ...
    <div class="col-lg-6 mb-5 own_premises" @if (isset($family_details->premises) && $family_details->premises == 'others') style="display:none" @endif>
        ...
        <input name="relation_register_no" id="relation_register_no"
            value="{{ $family_details->registration_no ?? '' }}"
            class="form-control form-control-lg form-control-solid" />
        <!--end::Input-->
    </div>
    ...
    <div class="col-lg-6 mb-5">
        ...
        <input name="relation_standard" id="relation_standard" value="{{ $family_details->standard ?? '' }}"
            class="form-control form-control-lg form-control-solid" />
        <!--end::Input-->
    </div>
    <!--end::Input group-->
    ...
    <div class="col-lg-12 mb-5">
        ...
        <textarea name="occupation_address" id="occupation_address" class="form-control form-control-lg form-control-solid"
            rows="3">{{ $family_details->occupational_address ?? '' }}</textarea>
        <!--end::Input-->
    </div>
    <!--end::Input group-->
    <div class="d-flex flex-stack pt-5">
        <!--begin::Wrapper-->
        <div>
            <button type="button" class="btn btn-primary" onclick="return submitFamilyMemberForm()">
