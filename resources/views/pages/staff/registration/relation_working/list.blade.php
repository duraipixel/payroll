            ...
            @isset($working_details)
                @foreach ($working_details as $item)
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="#" onclick="return editRelationWorkingForm('{{$item->staff_id}}', '{{ $item->id }}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <a href="#" onclick="return deleteRelationWorking('{{ $item->staff_id }}', '{{ $item->id }}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
