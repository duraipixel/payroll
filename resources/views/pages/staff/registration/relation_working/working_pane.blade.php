<div class="tble-fnton card mt-10 mb-5 mb-xl-8">
    ...
    <div class="card-header bg-primary border-0 pt-0">
        ...
        <button id="kt_new_aews_toggle" style="display: none;"
    ...
    <!--end::Header-->
    <!--begin::Body-->
    <div class="card-body py-3" id="working-relation-list-pane">
        <!--begin::Table container-->
        @include('pages.staff.registration.relation_working.list')
        <!--end::Table container-->
    </div>
    <!--begin::Body-->
</div>