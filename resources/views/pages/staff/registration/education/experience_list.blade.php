            ...
            @isset($experience_details)
                @foreach ($experience_details as $item)
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="javascript:void(0)" onclick="return editExperience('{{$item->staff_id}}', '{{ $item->id }}')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <a href="javascript:void(0)" onclick="return deleteExperience('{{$item->staff_id}}', '{{ $item->id }}')"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                <span class="svg-icon svg-icon-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none">
                                        <path
