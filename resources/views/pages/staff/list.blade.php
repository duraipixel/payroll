                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                    ...
                                    data-select2-id="select2-data-10-w4yo" tabindex="-1" aria-hidden="true">
                                    <option data-select2-id="select2-data-12-nvah"></option>
                                    ...
                                    dir="ltr" data-select2-id="select2-data-11-l2zp" style="width: 100%;"><span
                                        class="selection"><span
                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                            role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                            aria-disabled="false" aria-labelledby="select2-ct71-container"
                                            aria-controls="select2-ct71-container"><span class="select2-selection__rendered"
                                                id="select2-ct71-container" role="textbox" aria-readonly="true"
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                    ...
                                    data-select2-id="select2-data-13-8fam" tabindex="-1" aria-hidden="true">
                                    <option data-select2-id="select2-data-15-bird"></option>
                                    <option value="Enabled">Enabled</option>
                                </select><span class="select2 select2-container select2-container--bootstrap5"
                                    dir="ltr" data-select2-id="select2-data-14-t54o" style="width: 100%;"><span
                                        class="selection"><span
                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                            role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                            aria-disabled="false" aria-labelledby="select2-wvdn-container"
                                            aria-controls="select2-wvdn-container"><span
                                                class="select2-selection__rendered" id="select2-wvdn-container"
                                ...
                                <form id="kt_modal_export_users_form"
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <select name="role" data-control="select2" data-placeholder="Select a role"
                                            ...
                                            data-select2-id="select2-data-16-vmfc" tabindex="-1" aria-hidden="true">
                                            <option data-select2-id="select2-data-18-hge8"></option>
                                            <option value="Administrator">Administrator</option>
                                            <option value="Analyst">Analyst</option>
                                            <option value="Developer">Developer</option>
                                            <option value="Support">Support</option>
                                            ...
                                            dir="ltr" data-select2-id="select2-data-17-hi5l"
                                            style="width: 100%;"><span class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-role-zp-container"
                                                    aria-controls="select2-role-zp-container"><span
                                                        class="select2-selection__rendered" id="select2-role-zp-container"
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <select name="format" data-control="select2" data-placeholder="Select a format"
                                            data-hide-search="true"
                                            class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                            data-select2-id="select2-data-19-3v89" tabindex="-1" aria-hidden="true">
                                            <option data-select2-id="select2-data-21-ngih"></option>
                                            <option value="excel">Excel</option>
                                            <option value="pdf">PDF</option>
                                            <option value="cvs">CVS</option>
                                            <option value="zip">ZIP</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5"
                                            dir="ltr" data-select2-id="select2-data-20-na65"
                                            style="width: 100%;"><span class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-format-3g-container"
                                                    aria-controls="select2-format-3g-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-format-3g-container" role="textbox"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                    rowspan="1" colspan="1" style="width: 355.733px;"
                                    aria-label="User: activate to sort column ascending">User</th>
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                    rowspan="1" colspan="1" style="width: 198.7px;"
                                ...
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                    rowspan="1" colspan="1" style="width: 198.7px;"
                                    aria-label="Two-step: activate to sort column ascending">Two-step</th>
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                    rowspan="1" colspan="1" style="width: 258.4px;"
                                    aria-label="Joined Date: activate to sort column ascending">Joined Date</th>
                                <th class="text-end min-w-100px sorting_disabled" rowspan="1" colspan="1"
                                    style="width: 160.017px;" aria-label="Actions">Actions</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr class="odd">
                                ...
                                <!--end::Role=-->
                                <!--begin::Last login=-->
                                <td data-order="2023-03-23T15:43:50+05:30">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-06-20T20:43:00+05:30">20 Jun 2022, 8:43 pm</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                            ...
                            <tr class="even">
                                ...
                                <!--end::Role=-->
                                <!--begin::Last login=-->
                                <td data-order="2023-03-24T15:23:50+05:30">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-03-10T10:30:00+05:30">10 Mar 2022, 10:30 am</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                            ...
                            <tr class="odd">
                                ...
                                <!--end::Role=-->
                                <!--begin::Last login=-->
                                <td data-order="2023-03-21T15:43:50+05:30">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-06-20T10:30:00+05:30">20 Jun 2022, 10:30 am</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                            ...
                            <tr class="even">
                                ...
                                <!--end::Role=-->
                                <!--begin::Last login=-->
                                <td data-order="2023-03-24T10:43:50+05:30">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-07-25T22:10:00+05:30">25 Jul 2022, 10:10 pm</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                            ...
                            <tr class="odd">
                                ...
                                <!--end::Role=-->
                                <!--begin::Last login=-->
                                <td data-order="2023-03-22T15:43:50+05:30">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-11-10T11:30:00+05:30">10 Nov 2022, 11:30 am</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                            ...
                            <tr class="even">
                                ...
                                <!--end::Role=-->
                                <!--begin::Last login=-->
                                <td data-order="2023-03-19T15:43:50+05:30">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-05-05T21:23:00+05:30">05 May 2022, 9:23 pm</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                            ...
                            <tr class="odd">
                                ...
                                <!--end::Role=-->
                                <!--begin::Last login=-->
                                <td data-order="2023-03-03T15:43:50+05:30">
                            ...
                            <tr class="even">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-06-24T21:23:00+05:30">24 Jun 2022, 9:23 pm</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                            ...
                            <tr class="odd">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-11-10T21:23:00+05:30">10 Nov 2022, 9:23 pm</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                            ...
                            <tr class="even">
                                ...
                                <!--end::Two step=-->
                                <!--begin::Joined-->
                                <td data-order="2022-02-21T17:20:00+05:30">21 Feb 2022, 5:20 pm</td>
                                <!--begin::Joined-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
