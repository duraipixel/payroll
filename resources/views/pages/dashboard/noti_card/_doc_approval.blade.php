<div class="card-body d-flex justify-content-center text-center flex-column p-8">
    <a href="{{ route('user.document_locker') }}" class="text-gray-800 text-hover-primary d-flex flex-column">
        ...
        <div class="fs-5 fw-bolder mb-2"> Document Approval</div>
    </a>
        ...
        <span class="fs-6 text-light-700 fw-bolder">
            <span class="fs-6 text-light-700 fw-bolder">
                <span class="ms-n1 counted" data-kt-countup="true"
                    data-kt-countup-value="45">{{ count( $document_approval ) }}</span>
            </span>
        </span>
    </span>
</div>