<a class="card d-block" href="{{ route('user.document_locker') }}">
    <div class="card-body p-3">
        <div class="row m-0">
            ...
            <div class="col-lg-8 p-0">
                <div class="fs-5 fw-bolder mb-2">Doc's Approval
                    @if (count($document_approval))
                        <span class="badge bg-danger">{{ count($document_approval) }}</span>
                    @endif
                </div>
